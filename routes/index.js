...
router.get("/", renderController.renderSitpCourses);
...
router.post("/register-course", userController.registerCourse);
...
router.get("/sitp-iot", sitpController.iot);
router.get("/sitp-frontend", sitpController.frontend);
router.get("/sitp-ml", sitpController.ml);
router.get("/sitp-digital-marketing", sitpController.marketing);
router.get("/sitp-product-dev", sitpController.pd);
router.get("/sitp-product-ds", sitpController.ds);
router.get("/sitp-product-javascript", sitpController.js);
